...
// Config Model
struct WhatsAppConfig: Identifiable, Codable {
    let id : UUID
    ...
    init(id : UUID = UUID(), accessToken : String, phoneNumberId : String, webhoookServerURL : String, localWebhookPort :String){
        self.id = id
        self.accessToken = accessToken
        self.phoneNumberId = phoneNumberId
        self.webhookServerURL = webhoookServerURL
        self.localWebhookPort = localWebhookPort
    }
    
    static let ⁠defaultConfig: [WhatsAppConfig] = [
        WhatsAppConfig(
            accessToken: "",
            phoneNumberId: "",
            webhoookServerURL: "http://localhost:3000",
