...
//    @StateObject private var viewModel: CollaboratorsViewModel
    @State private var showingAddCollaborator = false
    
//    init(conversation: Conversation) {
//        _viewModel = StateObject(wrappedValue: CollaboratorsViewModel(conversation: conversation))
//    }
...
//        .popover(isPresented: $showingAddCollaborator, arrowEdge: .trailing) {
//            AddCollaboratorView(viewModel: viewModel)
...
#Preview("No Labels") {
    ChatDetailView(conversation: Conversation.humanDummyData[1])
        .frame(width: 334)
}
